...
# List wrappers (optioneel, maar handig als je wilt uitbreiden)
class PostingList(ORMModel):
    __root__: List[PostingOut]

class ApplicationList(ORMModel):
    __root__: List[ApplicationOut]
