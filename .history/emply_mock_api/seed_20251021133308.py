...
def seed():
    ...
    for _ in range(30):
        ...
        # 👇 Losse variabelen buiten de constructor (fix voor JSON Decimal-probleem)
    ...
    for p in postings:
        for _ in range(randint(0, 8)):
            ...
            a = Application(
                ...
                disqualify_reason=None if randint(0, 3) else {
                    "localization": [{"locale": "en", "value": "Not a fit"}]
                },
